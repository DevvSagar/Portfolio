      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-xl bg-white rounded-3xl shadow-2xl border border-black/[0.08] z-10 my-8 overflow-hidden max-h-[90vh] flex flex-col"
          >
            {/* Top Header Row with Number & Dedicated Close Button */}
            <div className="flex items-center justify-between px-6 sm:px-8 pt-6 pb-3 border-b border-zinc-100 bg-white z-20 flex-shrink-0">
            ...
            <div className="overflow-y-auto px-6 sm:px-8 py-6 space-y-6 flex-1">
              {/* Header */}
              <div>
                <h2 id="service-modal-title" className="text-2xl sm:text-3xl font-extrabold text-zinc-900 tracking-tight">
                  {service.title}
                </h2>
              ...
              {service.deliverables && (
                <div className="bg-zinc-50 border border-zinc-200/80 rounded-2xl p-5">
                  <h3 className="text-xs font-semibold uppercase tracking-wider text-zinc-600 mb-3 flex items-center gap-2">
              ...
              {service.technologies && (
                <div>
                  <h3 className="text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-2.5 flex items-center gap-2">
              ...
              <div className="pt-4 border-t border-zinc-100 flex items-center justify-between gap-3">
                ...
                <button
                  onClick={onClose}
                  className="text-xs font-medium text-zinc-500 hover:text-black transition-colors cursor-pointer"
                >
                  Close
                </button>
              </div>
