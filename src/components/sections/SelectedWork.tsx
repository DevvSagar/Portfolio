...
export const SelectedWork: React.FC<SelectedWorkProps> = ({ onOpenContact }) => {
  ...
  return (
    <section id="work" className="relative w-full py-20 sm:py-28 bg-white overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10 pb-4 border-b border-zinc-100">
          {/* Tabs */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          {filteredProjects.map((project, index) => (
            <motion.article
              ...
              className="group cursor-pointer flex flex-col bg-zinc-50/70 border border-zinc-200/80 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl hover:border-zinc-300 transition-all duration-300"
            >
              ...
              <div className="p-6 sm:p-7 flex flex-col flex-1 justify-between bg-white">
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold text-zinc-900 tracking-tight group-hover:text-black transition-colors mb-2">
                    {project.title}
                  </h3>
